...
import styles from "./transfer-active.css?inline"
import { BackupKey } from 'qrgopass-client/dist/types';

const QRGOPASS_WEB_CRYPTO_CODE = 5;

export const TransferActive = component$(({ transferState }: { transferState: Signal<UserCredentials | QRGoPassFailure | BackupKey | null> }) => {
